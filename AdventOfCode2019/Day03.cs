...
namespace AdventOfCode2019
{
    public class Day03
    {
        public static void Run()
        {
            ...
            var a = crosses.Min(x => Math.Abs(x.Item1) + Math.Abs(x.Item2));
            var b = crosses.Min(x => positions[0].IndexOf(x) + positions[1].IndexOf(x));

            Console.WriteLine($"Part A: {a}"); // 3247
            Console.WriteLine($"Part B: {b}"); // 48054
        }
    }
}
